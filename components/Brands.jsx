...
const Brands = () => {
  return (
    <section className="w-full h-[24vh] pt-24 flex items-center justify-center">
        <motion.div variants={fadeOnScroll(0.2, 0.6)} initial="hidden" whileInView="visible" className="container mx-auto overflow-hidden">
            <p className="lead text-center mb-6">Junte-se a mais de 200+ empresas que já estão crescendo</p>
        <div className="flex">
